...
{{-- end of breadcrumb --}}
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form id="filterForm"  method="POST" class="row align-items-end" action= {{route("fournisseurs.search")}}>
                @csrf
                <div class="col-md-3">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="detailContent">
                 @include('fournisseurs.modify-form')
            </div>
        ...
        swal({
            ...
            if (result) {
                ...
                let options = {
                    ...
                    url: "{{ route('fournisseurs.state', ['state'=>true]) }}",
                    data: {id:id},
                    dataType: "json",
        ...
        swal({
            ...
            if (result) {
                ...
                let options = {
                    ...
                    url: "{{ route('fournisseurs.state', ['state' => 0]) }}",
                    data: {id:id},
                    dataType: "json",
                    success: function (response) {
